...
def insert_upcoming_games(website_url):
   ...
   # options.headless = True
    ...
    for id in new_ids:
        ...
        scheduled_game_home_list.append(
            (id, website_url_elements[3], website_url_elements[5], website_url_elements[4], year_month_day, team_home.text, 1, 1, datetime.datetime.now()))
        scheduled_game_away_list.append(
            (id, website_url_elements[3], website_url_elements[5], website_url_elements[4], year_month_day, team_away.text, 0, 1, datetime.datetime.now()))
    # print(games_list)
